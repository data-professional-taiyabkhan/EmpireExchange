  ...
  return (
    <section className="bg-brand text-white">
      <div className="container py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          <h3 className="text-xl font-semibold">Ready to discuss wholesale pricing?</h3>
          <p className="text-white/90">Tell us your requirements and we&apos;ll get back within one business day.</p>
        </div>
